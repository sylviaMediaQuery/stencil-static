...
let windowlogin;
const PayCargoLoginComponent = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.loginResponse = index.createEvent(this, "paycargoLogin", 6);
    this.brand = '';
    this.type = '';
    ...
    this.openIframe = () => {
      ...
      const appURL = (_a = config.config.appHostsOptions[store.state.env]) !== null && _a !== void 0 ? _a : config.config.appHostsOptions['dev'];
      const url = `${appURL}?brand=${store.state.code}&type=id_token&redirect_url=${this._options.originURL}`;
  ...
  render() {
    return (index.h("button", { id: "paycargo-login-button", onClick: this.openIframe }, "Login to PayCargo"));
  }
};
PayCargoLoginComponent.style = loginCss;

exports.paycargo_login = PayCargoLoginComponent;
