...
import { d as defineCustomElement$3 } from './loading-spinner2.js';
import { d as defineCustomElement$2 } from './notification-message2.js';
...
let bluesnapObj;
const PayCargoCartComponent = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return cartCss; }
    ...
    "options": [1],
    "developerToken": [1, "developer-token"],
    "pcData": [1, "pc-data"],
    "visible": [1540],
    "handleClose": [16],
    "regions": [32],
    ...
    "validForm": [32],
    "validTransaction": [32],
    "showApprovedNotification": [32],
    "transactionMessage": [32],
    "messageType": [32]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["paycargo-cart", "loading-spinner", "notification-message"];
  components.forEach(tagName => { switch (tagName) {
    case "paycargo-cart":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PayCargoCartComponent);
      }
      break;
...
const PaycargoCart = PayCargoCartComponent;
const defineCustomElement = defineCustomElement$1;

export { PaycargoCart, defineCustomElement };
